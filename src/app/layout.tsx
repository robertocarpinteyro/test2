...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "NIDDO | Encuentra tu hogar ideal en bosque real | NIDDIA Asistente Virtual",
    template: "%s | NIDDO Bosque Real",
  },
  description:
    "NIDDO es el broker inmobiliario líder especializado en propiedades de lujo en Bosque Real, Estado de México. Con NIDDIA, nuestra asistente virtual con inteligencia artificial, encuentra tu hogar exclusivo en Bosque Real con asesoría personalizada.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Líder broker inmobiliario especializado en Bosque Real, Estado de México. Con NIDDIA, asistente virtual IA, encuentra tu propiedad exclusiva en Bosque Real.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
  ...
  twitter: {
    ...
    description:
      "Broker especialista en propiedades exclusivas de Bosque Real, Estado de México. NIDDIA asistente virtual con inteligencia artificial.",
