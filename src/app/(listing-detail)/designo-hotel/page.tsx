    ...
    return (
      <div className="listingSection__wrap !space-y-6">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold">
          Designo Hotel & Residential Suites
        </h2>
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div className="text-neutral-6000 dark:text-neutral-300">
          <span>
            Grupo Bosque Real presenta su primer MIX PROJECT, en el mejor
            desarrollo de América Latina Bosque Real, fusionando armoniosamente
            espacios empresariales, suites residenciales y un exclusivo hotel.
          </span>
        </div>
      </div>
    );
        ...
        <div className="aspect-w-5 aspect-h-5 sm:aspect-h-3 ring-1 ring-black/10 rounded-xl z-0">
          <div className="rounded-xl overflow-hidden z-0">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1582.1384317463373!2d-99.29523278030813!3d19.413245905192916!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d207bf2b9c7a47%3A0x8cb564d59884a0d5!2sDESIGNO%20PININFARINA%20TORRE%201%20OFICINAS!5e0!3m2!1ses!2smx!4v1734547946925!5m2!1ses!2smx"
            ></iframe>
          </div>
        </div>
      </div>
      ...
      <div className="listingSectionSidebar__wrap shadow-xl">
        ...
        <div className="flex flex-col space-y-4">
          <div className="flex justify-between text-neutral-6000 dark:text-neutral-300">
            <span>Superficie total 81.24m² </span>
          </div>
          <div className="flex justify-between text-neutral-6000 dark:text-neutral-300">
            <span>Fecha de entrega</span>
            <span>Diciembre 2027 + 6 meses de gracia.</span>
          </div>
    ...
    <div className="nc-ListingStayDetailPage">
      ...
      <main className=" relative z-10 mt-11 flex flex-col lg:flex-row ">
        ...
        <div className="w-full lg:w-3/5 xl:w-2/3 space-y-8 lg:space-y-10 lg:pr-10">
          ...
          {renderSection7()}
          <div id="niddia"></div>
            <Niddia indexValue="departamento" selectedOption="designohotel" iframeSrc="https://interfaces.zapier.com/embed/chatbot/cmakndozr004m828y3mqnoqxq"/>
          {/*<SectionDateRange />*/}
        </div>
