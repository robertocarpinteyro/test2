...
const ListingStayDetailPage: FC<ListingStayDetailPageProps> = ({}) => {
  ...
  const renderSection8 = () => {
    const images = [
      "https://www.bosquereal.com.mx/wp-content/uploads/2024/09/isla-del-arbol-1.jpg",
      "https://www.bosquereal.com.mx/wp-content/uploads/2024/09/isla-del-arbol-5.jpg",
    ];
      ...
      <div className="listingSectionSidebar__wrap shadow-xl">
        ...
        <div className="flex flex-col space-y-4">
          <div className="flex justify-between text-neutral-6000 dark:text-neutral-300">
            <span>Superficie total 280 m² </span>
          </div>
          <div className="flex justify-between text-neutral-6000 dark:text-neutral-300">
            <span>Fecha de entrega</span>
            <span>Junio 2025 más 6 meses de gracia.</span>
          </div>
    ...
    <div className="nc-ListingStayDetailPage">
      ...
      <main className=" relative z-10 mt-11 flex flex-col lg:flex-row ">
        ...
        <div className="w-full lg:w-3/5 xl:w-2/3 space-y-8 lg:space-y-10 lg:pr-10">
          ...
          {renderSection7()}
          <div id="niddia"></div>
          <Niddia indexValue="lotes" selectedOption="islaArbol" iframeSrc = "https://interfaces.zapier.com/embed/chatbot/cmakobkap001nm049v17lva4z"/>
          {/*<SectionDateRange />*/}
        </div>
