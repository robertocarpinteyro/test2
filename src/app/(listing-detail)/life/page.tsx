        ...
        <div>
          ...
          <div className="relative w-full h-64 mt-3">
            <Image
              ...
              src="https://www.bosquereal.com.mx/wp-content/uploads/2023/10/plano-life-lp-1.webp"
              alt="Plano Life"
    ...
    <div className="nc-ListingStayDetailPage">
      ...
      <main className=" relative z-10 mt-11 flex flex-col lg:flex-row ">
        ...
        <div className="w-full lg:w-3/5 xl:w-2/3 space-y-8 lg:space-y-10 lg:pr-10">
          ...
          {renderSection7()}
          <div id="niddia"></div>
            <Niddia indexValue="lotes" selectedOption="life" iframeSrc="https://interfaces.zapier.com/embed/chatbot/cmakoo8md002f1208qk07uij7"/>
          {/*<SectionDateRange />*/}
        </div>
