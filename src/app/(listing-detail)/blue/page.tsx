    ...
    return (
      <div className="listingSection__wrap !space-y-6">
        ...
        <div className="flex justify-between items-center">
          <Badge name={t("developments.blue.luxuryDepartments")} />
          <LikeSaveBtns />
        </div>
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div className="text-neutral-6000 dark:text-neutral-300">
          <span>
            {t("developments.blue.description")}
          </span>
        </div>
      </div>
    );
      ...
      <div className="listingSectionSidebar__wrap shadow-xl">
        ...
        <div className="flex flex-col space-y-4">
          <div className="flex justify-between text-neutral-6000 dark:text-neutral-300">
            <span>{t("developments.blue.totalSurface")} </span>
          </div>
          <div className="flex justify-between text-neutral-6000 dark:text-neutral-300">
            <span>{t("developments.common.deliveryDate")}</span>
            <span>{t("developments.blue.deliveryDateValue")}</span>
          </div>
    ...
    <div className="nc-ListingStayDetailPage">
      ...
      <main className=" relative z-10 mt-11 flex flex-col lg:flex-row ">
        ...
        <div className="w-full lg:w-3/5 xl:w-2/3 space-y-8 lg:space-y-10 lg:pr-10">
          ...
          <Niddia indexValue="departamento" selectedOption="blue" iframeSrc="https://interfaces.zapier.com/embed/chatbot/cmakn49ka001xovivcmizr255"/>
          {/*<SectionDateRange />*/}
        </div>
