    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div className="text-neutral-6000 dark:text-neutral-300">
          <span>
          ¡Bienvenido a Incanto Residencial en Bosque Real, tu propio paraíso dentro de la ciudad! Aquí, la modernidad y el lujo se fusionan con el esplendor de la naturaleza para ofrecerte una vida de armonía, seguridad y una experiencia única.
          </span>
        </div>
      </div>
    );
    ...
    <div className="nc-ListingStayDetailPage">
      ...
      <main className=" relative z-10 mt-11 flex flex-col lg:flex-row ">
        ...
        <div className="w-full lg:w-3/5 xl:w-2/3 space-y-8 lg:space-y-10 lg:pr-10">
          ...
          {renderSection7()}
          <div id="niddia"></div>
          <Niddia indexValue="departamento" selectedOption="cientoochenta"/>
          {/*<SectionDateRange />*/}
        </div>
